...
// Sprint 2.5: scenario selection logic moved to ./sessionPicker for unit
//   testing. Public API of this module is preserved via re-exports so no
//   downstream caller needs to change imports.
//
// Hybrid architecture: Phaser owns interaction, React owns content rendering.

import Phaser from "phaser";
import type { Tier } from "./sessionPicker";

// Re-export so existing callers importing from "./game" keep working.
export type { Tier, Scenario } from "./sessionPicker";
export { getAllScenarios, pickSessionScenarios } from "./sessionPicker";
